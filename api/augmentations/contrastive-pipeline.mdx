...
description: "Reference for ContrastiveAugmentationPipeline, a thin wrapper around ECGAugmentations that generates SSL view pairs for DataLoader pretraining pipelines."
---
