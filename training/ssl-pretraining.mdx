...
<Tabs>
  ...
  <Tab title="BYOL">
    ...
    **Recommended command:**
    ...
    <ParamField path="--epochs" type="int" default="20">
      Number of full passes over the unlabeled training split.
    </ParamField>
    ...
    <ParamField path="--lr" type="float" default="1e-3">
      Learning rate for the Adam optimizer applied to the online encoder, projector, and predictor.
    </ParamField>

    <ParamField path="--signal-length" type="int" default="1000">
      Number of time steps to load per ECG record. At 100 Hz this corresponds to 10 seconds.
    </ParamField>
